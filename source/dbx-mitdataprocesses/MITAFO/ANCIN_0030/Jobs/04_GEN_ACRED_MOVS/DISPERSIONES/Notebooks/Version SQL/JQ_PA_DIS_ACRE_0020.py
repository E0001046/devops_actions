...
# MAGIC         result_table_020 = config.get(arg_process_name, "table_020")
# MAGIC     except (ValueError, IOError) as error:
...
df.createOrReplaceGlobalTempView("TEMP_DOIMSS_ACR_01")
spark.sql("SELECT * FROM global_temp.TEMP_DOIMSS_ACR_01").show()
...
# MAGIC %md
# MAGIC ### Estos son los datos que se usaran para hacer el update hacia CIERREN_ETL.TTSISGRAL_ETL_MOVIMIENTOS
...
table_name_001 = f"{conn_schema_001}.{table_020}"
MODE = "APPEND"
...
table_name_001 = conn_schema_001 + "." + table_007
table_name_002 = conn_schema_001 + "." + table_020
...
table_name_001 = conn_schema_001 + "." + table_020
