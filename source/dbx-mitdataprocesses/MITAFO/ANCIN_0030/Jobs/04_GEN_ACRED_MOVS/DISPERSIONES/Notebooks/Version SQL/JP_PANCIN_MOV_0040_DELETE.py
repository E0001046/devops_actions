...
df.createOrReplaceTempView("TEMP_VIEW_RECALCULO_01")
spark.sql("SELECT * FROM TEMP_VIEW_RECALCULO_01").show()

# COMMAND ----------

table_name_001 = "DBX_MIT_DEV_1UDBVF_WORKSPACE.DEFAULT.ORACLE_DISPERSIONES"
table_name_002 = "TEMP_VIEW_RECALCULO_01"
...
columns_to_modify = {
    "FTN_ORIGEN_APORTACION": IntegerType(),
}
...
# df = df.fillna(
#     {
#         "FTN_ORIGEN_APORTACION": 0,  # Mantiene nullables
#     }
# )
