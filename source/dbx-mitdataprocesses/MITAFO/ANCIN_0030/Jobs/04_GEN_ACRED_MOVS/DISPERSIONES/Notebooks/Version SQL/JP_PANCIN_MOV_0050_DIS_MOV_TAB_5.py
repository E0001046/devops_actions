...
# MAGIC     )
# MAGIC
# MAGIC     (failed_task,) = input_values()
# MAGIC
...
# MAGIC
# MAGIC     sql_conf_file = (
# MAGIC         "/Workspace/Repos/mronboye@emeal.nttdata.com/QueryConfigLab.ide/MITAFO/ANCIN_0030/Jobs/04_GEN_ACRED_MOVS/DISPERSIONES/JSON/"
# MAGIC         + sql_conf_file
# MAGIC     )
# MAGIC
...
table_name_001 = "global_temp.TEMP_DOIMSS_ACR_01"
...
table_name_001 = f"{conn_schema_002}.{table_016}"
MODE = "APPEND"
