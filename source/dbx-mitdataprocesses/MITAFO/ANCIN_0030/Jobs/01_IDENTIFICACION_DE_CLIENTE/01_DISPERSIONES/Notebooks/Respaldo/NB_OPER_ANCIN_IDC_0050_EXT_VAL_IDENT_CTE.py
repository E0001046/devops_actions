...
# MAGIC     return sql_conf_file, conn_schema_001, table_002, conn_schema_002, table_006, global_temp_view_002,global_temp_view_schema_001,global_temp_view_001,global_temp_view_003,global_temp_view_004, '1'
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file, conn_schema_001, table_002, conn_schema_002, table_006, global_temp_view_002,global_temp_view_schema_001,global_temp_view_001,global_temp_view_003,global_temp_view_004, failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
...
#table_001 : TTSISGRAL_ETL_VAL_IDENT_CTE
#conn_schema_002 : CIERREN
#table_006 : TTCRXGRAL_FOLIO

table_name_001 = conn_schema_001 + '.' + table_002
...
# DBTITLE 1,CREACIÓN DE VISTA TEMP_CLIENTE_NO_IDEN
temp_view = global_temp_view_003 + '_' + sr_id_archivo
print(temp_view)
spark.catalog.dropGlobalTempView(temp_view)

df.createOrReplaceGlobalTempView(temp_view)

#spark.sql("select * from global_temp.TEMP_CLIENTE_NO_IDEN_29288").show()
#spark.sql(f"select * from global_temp.TEMP_CLIENTE_NO_IDEN_{sr_id_archivo}").count()


# COMMAND ----------

# DBTITLE 1,CLIENTES NO IDENTIFICADOS
temp_view_001 = global_temp_view_schema_001 + '.' + global_temp_view_002 + '_' + sr_id_archivo
temp_view_002 = global_temp_view_schema_001 + '.' + global_temp_view_003 + '_' + sr_id_archivo
...
# DBTITLE 1,CREACIÓN DE VISTA GLOBAL TEMP_UNION_CLIENTE
