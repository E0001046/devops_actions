...
# MAGIC from pyspark.sql.functions import length, lit, current_timestamp, concat, col, when, lead, monotonically_increasing_id
...
# MAGIC         indexed_df = df.withColumn("FTN_NO_LINEA", monotonically_increasing_id() + 1)
...
temp_view = "TEMP_VALIDACION_ESTRUCTURA_ARCHIVO" + "_" + sr_id_archivo

#dfVal.persist(StorageLevel.DISK_ONLY)

try:
    dfVal.createOrReplaceGlobalTempView(temp_view)
