...
# MAGIC
# MAGIC #   ,'0','0','0','0'
# MAGIC #   sr_instancia_proceso, sr_usuario, sr_etapa, sr_id_snapshot
# MAGIC     
...
# DBTITLE 1,Delete _MONTOS_CLIENTE_AUX Part 1
statement = f"""
...
spark.conf.set("sr_tipo_mov", str(sr_tipo_mov.lower()))

# COMMAND ----------

# DBTITLE 1,Delete _MONTOS_CLIENTE_AUX Part 2
# MAGIC %scala
...
# DBTITLE 1,Delete _MONTOS_CLIENTE_AUX Part 3
...
# DBTITLE 1,JP_PANCIN_MCV_0110_MONTOS_CTE_DS
query_statement = '013'
...
# DBTITLE 1,Insert MONTOS_CLIENTE_AUX
...
#    print("Se realiza la insersión a la tabla: " + table_name_001)
...
statement = f'''
SELECT * FROM CIERREN_DATAUX.TTSISGRAL_ETL_MONTOS_CLIENTE_AUX WHERE FTC_FOLIO = '{sr_folio}' 
'''
...
# MAGIC val conn_key = spark.conf.get("conn_key")
# MAGIC val conn_url = spark.conf.get("conn_url")
# MAGIC val sr_tipo_mov = spark.conf.get("sr_tipo_mov")
# MAGIC val driverClass = "oracle.jdbc.driver.OracleDriver"
# MAGIC
# MAGIC Class.forName(driverClass)
# MAGIC  
