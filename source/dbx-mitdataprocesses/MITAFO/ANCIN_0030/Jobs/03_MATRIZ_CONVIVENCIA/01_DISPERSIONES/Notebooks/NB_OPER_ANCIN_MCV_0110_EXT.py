...
tempViewPrev = f"{catalog_name}.{schema_name}.{'TEMP_DOIMSS_MCV_MONTOS_CLIENTE_PREV' + '_' + sr_folio}"
...
tempView = f"{catalog_name}.{schema_name}.{'TEMP_DOIMSS_MCV_MONTOS_CLIENTE' + '_' + sr_folio}"
...
#spark.sql(f"DROP TABLE IF EXISTS {tempView}")
