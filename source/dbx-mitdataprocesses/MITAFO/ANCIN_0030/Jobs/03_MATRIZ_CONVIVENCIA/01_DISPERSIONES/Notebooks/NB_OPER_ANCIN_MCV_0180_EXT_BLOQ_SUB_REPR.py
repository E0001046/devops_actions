...
# MAGIC         sql_conf_file = config.get(process_name, 'sql_conf_file_bloqueo_sub_repr')
# MAGIC         # Unity
...
# DBTITLE 1,Update VAL_MATRIZ_CONV  Part 1
statement = f"""
UPDATE CIERREN_ETL.TLSISGRAL_ETL_VAL_MATRIZ_CONV 
SET FTB_ESTATUS_MARCA = '2' 
...
# DBTITLE 1,Update VAL_MATRIZ_CONV  Part 2
# MAGIC %scala
...
# DBTITLE 1,Update VAL_MATRIZ_CONV  Part 3
...
# DBTITLE 1,JP_PANCIN_MCV_0180_MONTOS_CTE_MV
query_statement = '001'

params = [sr_folio, sr_folio_rel ,sr_proceso, sr_subproceso]
...
#df.createOrReplaceGlobalTempView("TEMP_DOIMSS_MCV_MONTOS_CLIENTE")
