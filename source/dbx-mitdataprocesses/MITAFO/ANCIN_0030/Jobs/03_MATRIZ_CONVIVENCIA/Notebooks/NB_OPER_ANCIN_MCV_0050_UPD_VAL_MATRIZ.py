...
# DBTITLE 1,JP_PANCIN_MCV_0050_CARGA_MATRIZ
query_statement = '007'

params = [sr_folio, sr_folio_rel, sr_tipo_mov ,sr_proceso, sr_subproceso,'DATABRICKS']
...
#df.createOrReplaceTempView("Matriz_Conv")
...
# DBTITLE 1,SOLO DEV
#df = df.withColumnRenamed("FTC_ESTATUS_MARCA", "FTN_ESTATUS_MARCA")

# COMMAND ----------

# DBTITLE 1,INSERT MATRIZ_CONVIVENCIA_AUX
mode = 'APPEND'
 
table_name_001 = 'CIERREN_DATAUX.TTAFOGRAL_ETL_MATRIZ_CONVIVENCIA_AUX'
...
# DBTITLE 1,INSERT MATRIZ_CONVIVENCIA Part1
#Update then insert (MERGE)
...
# DBTITLE 1,INSERT MATRIZ_CONVIVENCIA Part2
# MAGIC %scala
...
# DBTITLE 1,INSERT MATRIZ_CONVIVENCIA Part3
