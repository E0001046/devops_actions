...
# Extracción de información correspondiente a INDICADORES
table_name_001 = conn_schema_002 + '.' + table_009
table_name_002 = conn_schema_002 + '.' + table_010
table_name_003 = conn_schema_002 + '.' + table_007
var_001 = var_001


query_statement = '003'

params = [table_name_001,table_name_002,table_name_003,var_001]
...
# DBTITLE 1,CONSTRUCCIÓN DE TABLA DELTA
temp_view = f"TEMP_DOIMSS_CTI_02_INDICADORES_{sr_folio}"
