...
# MAGIC     return sql_conf_file, conn_schema_001,table_001,table_002, '1'
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file, conn_schema_001,table_001,table_002, failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
...
# DBTITLE 1,3RA PARTE - CONTEO DE REGISTROS
...
temp_view = "TEMP_CONTEO_REGCONYSINVIV" + '_' + sr_id_archivo

# COMMAND ----------

# DBTITLE 1,CREACIÓN DE VISTA GLOBAL TEMP_CONTEO_REGCONYSINVIV
