...
# MAGIC     return sql_conf_file, conn_schema_001, table_001, table_002, conn_schema_002, table_003,conn_schema_003, table_004, '1'
# MAGIC
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file, conn_schema_001, table_001, table_002, conn_schema_002, table_003,conn_schema_003, table_004, failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
...
# DBTITLE 1,1RA PARTE DE LA EXTRACCIÓN - DISPERSIONES
table_name_001 = conn_schema_001 + '.' + table_001
table_name_002 = conn_schema_001 + '.' + table_002
table_name_003 = conn_schema_002 + '.' + table_003
table_name_004 = conn_schema_003 + '.' + table_004

query_statement = '001'

params = [table_name_001, table_name_003,table_name_004,table_name_002,sr_folio]
...
temp_view = "TEMP_DISPERSION_CIFRAS" + '_' + sr_id_archivo

# COMMAND ----------

# DBTITLE 1,CREACIÓN DE VISTA GLOBAL TEMP_DISPERSION_CIFRAS
