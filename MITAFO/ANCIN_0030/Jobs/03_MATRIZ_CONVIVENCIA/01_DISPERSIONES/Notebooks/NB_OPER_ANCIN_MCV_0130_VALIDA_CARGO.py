...
# DBTITLE 1,Extrae y Crea vista TEMP_DOIMSS_MCV_03_CONVIV
query_statement = '002'
if sr_tipo_mov.lower() == 'cargo':
    sr_tipo_mov = 180

params = [sr_proceso, sr_subproceso, sr_tipo_mov, sr_folio]
...
temp_view = 'TEMP_DOIMSS_MCV_03_CONVIV' + '_' + sr_folio
...
# DBTITLE 1,Extrae y Crea vista DS_CONFIG_CONVIV
query_statement = '003'
...
temp_view = 'DS_CONFIG_CONVIV' + '_' + sr_folio
...
# DBTITLE 1,Extrae y Crea vista TEMP_DOIMSS_MCV_04_SUBPROCESO
query_statement = '004'
...
#Crea Vista temporal
temp_view = 'TEMP_DOIMSS_MCV_04_SUBPROCESO' + '_' + sr_folio
...
# DBTITLE 1,test - create temp table
...
DF_02_DISPERSIONES = spark.sql(f"SELECT * FROM {catalog_name}.{schema_name}.{table_name}")
...
temp_view = 'T_MONT' + '_' + sr_folio
temp_view2 = 'T_MONT_CON' + '_' + sr_folio
...
df.write.format("delta").mode("overwrite").saveAsTable(
    f"{catalog_name}.{schema_name}.{temp_view2}"
)
...
# DBTITLE 1,Crea vista TEMP_DOIMSS_MCV_06_NO_CONVIVEN
query_statement = '006'
...
temp_view = 'TEMP_DOIMSS_MCV_06_NO_CONVIVEN' + '_' + sr_folio
...
# DBTITLE 1,Crea vista TEMP_DOIMSS_MCV_05_TIPO_SALDO
query_statement = '007'
...
temp_view = 'TEMP_DOIMSS_MCV_05_TIPO_SALDO' + '_' + sr_folio
