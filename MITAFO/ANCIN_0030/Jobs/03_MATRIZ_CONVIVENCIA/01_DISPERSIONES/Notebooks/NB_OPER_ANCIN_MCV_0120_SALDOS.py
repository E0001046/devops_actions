...
# DBTITLE 1,JP_PANCIN_MCV_0120_CARGO_SALDOS_CTE_DS
query_statement = '001'

params = [sr_folio_rel,sr_fecha_acc]
...
# DBTITLE 1,CREA VISTA TEMP_DOIMSS_MCV_SALDOS_DISP
temp_view = 'TEMP_DOIMSS_MCV_SALDOS_DISP' + '_' + sr_folio
