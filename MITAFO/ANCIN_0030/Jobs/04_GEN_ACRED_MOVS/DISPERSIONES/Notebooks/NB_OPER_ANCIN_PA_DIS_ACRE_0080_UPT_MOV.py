...
# MAGIC %md
# MAGIC ### El df anterior se inserta en la tabla auxiliar `CIERREN_DATAUX.TTSISGRAL_ETL_MOVIMIENTOS_AUX`

# COMMAND ----------

target_table = f"{global_confs['conn_schema_003']}.{global_confs['table_014']}"
mode = "APPEND"
...
# MAGIC %md
# MAGIC ### Ahora hacemos el merge de los datos hacia `CIERREN_ETL.TTSISGRAL_ETL_MOVIMIENTOS`

# COMMAND ----------

query_statement = "024"

table_name_001 = f"{global_confs['conn_schema_001']}.{global_confs['table_002']}"
table_name_002 = f"{global_confs['conn_schema_003']}.{global_confs['table_014']}"
...
spark.conf.set("statement", str(formatted_statement))
