...
GLOBAL_TEMP_VIEW = "dbx_mit_dev_1udbvf_workspace.default.TEMP_DISPERSION_MOV_CARGO"
query_statement = "014"
...
TEMP_VIEW = "TEMP_DOIMSS_MOV_SUB_01"
df.createOrReplaceTempView(TEMP_VIEW)
spark.sql(f"SELECT * FROM {TEMP_VIEW}").show()

# COMMAND ----------

TEMP_VIEW_1 = "dbx_mit_dev_1udbvf_workspace.default.ORACLE_DISPERSIONES"
TEMP_VIEW_2 = "TEMP_DOIMSS_MOV_SUB_01"
...
TEMP_VIEW = "TEMP_DOIMSS_MOV_SUB_02"
df.createOrReplaceTempView(TEMP_VIEW)
spark.sql(f"SELECT * FROM {TEMP_VIEW}").show()
...
TEMP_VIEW_1 = "TEMP_DOIMSS_MOV_SUB_01"
TEMP_VIEW_2 = "TEMP_DOIMSS_MOV_SUB_02"
...
df = df.withColumn(
    "FCN_ID_PLAZO", df["FCN_ID_PLAZO"].cast("decimal(10,0)")
)  # Por alguna razon viene con otro tipo de formato
display(df)
...
# MAGIC %md
# MAGIC # NOTA:
# MAGIC ### En IBM DataStage, el proceso de TRUNCA la tabla TEMP_ORACLE_DISPERSIONES antes de insertar los del DF anterior.
# MAGIC ### Estatus: SOLUCIONADO (Se sobreescribe el catalogo de unity)

# COMMAND ----------

catalog_name = "dbx_mit_dev_1udbvf_workspace"
schema_name = "default"
table_name = "ORACLE_DISPERSIONES"
