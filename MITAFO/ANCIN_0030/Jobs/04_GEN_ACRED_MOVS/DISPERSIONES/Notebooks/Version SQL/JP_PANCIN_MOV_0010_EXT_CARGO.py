...
table_name_001 = conn_schema_002 + "." + table_011
table_name_002 = conn_schema_002 + "." + table_002
table_name_003 = conn_schema_002 + "." + table_005
table_name_004 = conn_schema_002 + "." + table_006
table_name_005 = conn_schema_001 + "." + table_001
table_name_006 = conn_schema_002 + "." + table_004

query_statement = "011"

params = [
    SR_CX_CRE_ESQUEMA,
    SR_TL_CRE_DISPERSION,
    table_name_001,
    table_name_002,
    table_name_003,
    SR_FTC_FOLIO,
...
schema_name = "default"
table_name = f"TEMP_DISPERSION_MOV_CARGO_{SR_FTC_FOLIO}"
