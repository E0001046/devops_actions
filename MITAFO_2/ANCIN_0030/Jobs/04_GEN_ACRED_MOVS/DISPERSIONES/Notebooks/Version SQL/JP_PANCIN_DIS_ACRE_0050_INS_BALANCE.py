...
table_name_001 = f"{conn_schema_002}.{table_006}"
...
df.createOrReplaceGlobalTempView("TEMP_DOIMSS_ACR_02")
spark.sql("SELECT * FROM global_temp.TEMP_DOIMSS_ACR_02").show()

# COMMAND ----------

table_name_001 = "DBX_MIT_DEV_1UDBVF_WORKSPACE.DEFAULT.ORACLE_DISPERSIONES"
table_name_002 = "global_temp.TEMP_DOIMSS_ACR_02"
...
table_name_001 = f"{conn_schema_001}.{table_007}"
...
# MAGIC %md
# MAGIC # NOTA:
# MAGIC ### el DF anterior deber ser un update a a la tabla CIERREN_ETL.TTSISGRAL_ETL_MOVIMIENTOS
