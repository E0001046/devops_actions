...
# MAGIC %md
# MAGIC # NOTA:
# MAGIC ### La Vista Temporal TEMP_ORACLE_DISPERSIONES_{SR_FTC_FOLIO} es usada por varios procesos, por lo que debería ser una tabla o un catalogo.
# MAGIC ### Estatus: SOLUCIONADO

# COMMAND ----------

# TEMP_VIEW = f"TEMP_ORACLE_DISPERSIONES_{SR_FTC_FOLIO}"
