...
# MAGIC     return sql_conf_file, conn_schema_001, table_001, conn_schema_002, table_006, global_temp_view_001,global_temp_view_002, '1'
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file, conn_schema_001, table_001, conn_schema_002, table_006, global_temp_view_001,global_temp_view_002, failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
...
temp_view = global_temp_view_001 + '_' + sr_id_archivo
...
df2 = df.select('FTC_FOLIO','FTN_NSS_CURP','FTN_ID_ARCHIVO', 'FTN_NO_LINEA', 'FTN_NSS','FTC_CURP')
display(df)
