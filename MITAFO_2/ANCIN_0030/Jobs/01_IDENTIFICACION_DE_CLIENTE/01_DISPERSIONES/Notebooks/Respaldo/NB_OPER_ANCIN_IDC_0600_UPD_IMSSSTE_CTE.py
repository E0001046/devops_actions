...
# MAGIC         return '0','0','0',
# MAGIC     return sql_conf_file, var_tramite, '1'
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file, var_tramite, failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
...
# DBTITLE 1,Genera vista TEMP_CTAS_VIG_CARGA

temp_view = 'TEMP_CTAS_VIG_CARGA' + '_' + sr_id_archivo
print(temp_view)
...
#display(df)
#spark.sql("select * from global_temp.TEMP_CTAS_VIG_CARGA_29288").show(10)
