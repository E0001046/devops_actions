...
# MAGIC     return sql_conf_file,conn_schema_001,table_009,global_temp_view_schema_001,global_temp_view_008,'1'
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file,conn_schema_001,table_009,global_temp_view_schema_001,global_temp_view_008,failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
