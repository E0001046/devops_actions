...
# MAGIC         global_temp_view_007 = config.get(process_name, 'global_temp_view_007')
# MAGIC         #
...
# MAGIC     return sql_conf_file, conn_schema_001, table_004, conn_schema_002, table_008, global_temp_view_007, tipo_identificador, '1'
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC     process_name = 'root'
# MAGIC     sql_conf_file, conn_schema_001, table_004, conn_schema_002, table_008, global_temp_view_007, tipo_identificador, failed_task = conf_process_values(config_process_file, process_name)
# MAGIC     if failed_task == '0':
# MAGIC         logger.error("Please review log messages")
# MAGIC         notification_raised(webhook_url, -1, message, source, input_parameters)
# MAGIC         raise Exception("Process ends")
...
table_name_002 = conn_schema_001 + '.' + table_004

query_statement = '007'

params = [table_name_001, table_name_002, table_name_003, tipo_identificador, sr_folio]
...
temp_view = global_temp_view_007 + '_' + sr_id_archivo
