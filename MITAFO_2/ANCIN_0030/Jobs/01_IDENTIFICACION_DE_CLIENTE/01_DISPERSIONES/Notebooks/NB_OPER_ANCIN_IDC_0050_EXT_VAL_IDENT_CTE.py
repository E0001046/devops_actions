...
temp_view = global_temp_view_003 + '_' + sr_id_archivo # TEMP_CLIENTE_NO_IDEN
...
temp_view_001 = f"{catalog_name}.{schema_name}.{global_temp_view_002}_{sr_id_archivo}"
temp_view_002 = f"{catalog_name}.{schema_name}.{global_temp_view_003}_{sr_id_archivo}"
...
temp_view = global_temp_view_004 + '_' + sr_id_archivo # TEMP_UNION_CLIENTE
df.write.format("delta").mode("overwrite").saveAsTable(
    f"{catalog_name}.{schema_name}.{temp_view}"
)
...
# DBTITLE 1,Liberacion de recursos
